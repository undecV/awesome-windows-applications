...
- [K-Lite Codec Pack](http://www.codecguide.com/): 軟體集，專業，上手難，功能強大。
- [VLC media player](https://www.videolan.org/vlc/): 功能強大，可換 Skin，好看。
#### Converter - 壓制轉檔
- [小丸工具箱](http://maruko.appinn.me/): 處理音視訊等多媒體檔案的軟體。
#### Editing - 剪輯
- [Avidemux](http://avidemux.org/): 日常影片處理。
#### Video Recording and Live Streaming - 錄屏和直播串流
- [Open Broadcaster Software](https://obsproject.com/): （簡稱：OBS）直播串流，錄屏。
### Image - 圖像
#### Viewer - 瀏覽器
- [ImageGlass](http://www.imageglass.org/): 輕量快速的圖片瀏覽器。
- ComicsViewer: 看漫畫。（[作者原文](https://www.cnblogs.com/stronghorse/p/4913182.html)）（[百度盤](http://yun.baidu.com/s/1qXFS9dy)）
- [IrfanView](http://www.irfanview.com/): 不僅僅是看圖。（[善用佳软](https://xbeta.info/use-irfanview.htm)）
#### Editor - 編輯器
- [GIMP](https://www.gimp.org/): 自由軟體界的 Photoshop。
- [Inkscape](https://inkscape.org/en/): 自由軟體界的 Ai 或 CorelDRAW。
- [CLIP STUDIO](http://www.clipstudio.net/): `商業軟體` 日本動漫製作的業界標準。
- [PaintTool SAI](http://systemax.jp/ja/sai/): `商業軟體` 插畫、漫畫。
...
### 3D
- [Blender](https://www.blender.org/): 開源 3D 創作軟體，除了 3D 還有影片編輯功能甚至游戲引擎。（功能多到不知道放哪ww...）（[Wikipedia](https://en.wikipedia.org/wiki/Blender_(software))）
## Embellish and Easy Access - 美化和便捷使用
- [Rainmeter](https://www.rainmeter.net/): 桌面美化必備，在桌面上增加自定義小部件。
- [RocketDock](https://rocketdock.com/): 收納快捷方式，讓桌面更簡潔。
  - **Extensions**
    - [StackDocklet](https://rocketdock.com/addon/docklets/47435)
- [QTTabBar](http://qttabbar.wikidot.com/): Windows 內置檔案總管（zhs：文件资源管理器）插件，為你的檔案總管添加標籤頁功能。
- [Carnac](http://carnackeys.com/): 屏幕上顯示鍵盤輸入。
- Wallpaper Engine: `商業軟體` ~~整個桌布都是我的播放器~~ 不只是動態桌布。（[Steam](http://store.steampowered.com/app/431960/Wallpaper_Engine/)）
## Files - 檔案處理
### Compression - 壓縮
#### All-In-One - 多格式支持
- [Bandizip](https://www.bandisoft.com/bandizip/)
- [PeaZip](http://www.peazip.org/)
#### Original Format - 自有格式原生
- [7-Zip](http://www.7-zip.org/): 7-Zip 格式原生。
- [WinRAR](http://www.rarlab.com/download.htm): `商業軟體` RAR 格式原生。~~（其實不要錢也能用）~~
- [Everything](https://www.voidtools.com/): 快速搜尋文件。
## Security - 安全
### Antivirus - 反病毒
- [Avast](https://www.avast.com/zh-tw/index): 來自捷克，免費防毒軟體。
- [Avira](https://www.avira.com/): 來自德國，免費防毒軟體。
### Others - 其他
- [Eraser](https://eraser.heidi.ie/): 檔案擦除，被擦除的檔案~~無法~~難以被恢復。
## Office - 辦公室＼文檔處理
### PDF - 可攜式文件格式
- [Sumatra PDF](https://www.sumatrapdfreader.org/free-pdf-reader.html): 小巧快速的 PDF、電子書閱讀器。
